   ...
   //menu de los clientes
    ...
    static void menuIngeniero() {
        ...
        while (!volver) {
            ...
            System.out.println("6. Mostrar reportes de mantenimiento");
            ...
            switch (op) {
                ...
                case 6 -> ingeniero.mostrarReportes();
                case 7 -> volver = true;
                default -> System.out.println("Opción inválida.");
            }
        }
    ...
    static void realizarRenta() {
        ...
        System.out.print("Horas de renta: ");
        ...
        Renta renta = new Renta(cliente, comp, tipoPago.getMonto(), tipoPago);
        rentas.add(renta);
